...
class TestConfiguration:
    ...
    def __init__(
        ...
        self.fixture_validator: Any = None
    ...
    def is_touchpoint_enabled(self, touchpoint: str) -> bool:
        ...
        return bool(touchpoint_config.get("enabled", True))
    ...
    def is_test_available_by_fixture(self, error_code: str) -> bool:
        ...
        return bool(self.fixture_validator.is_test_available(error_code, self.debug_mode))
    ...
    def get_test_fixture_status(self, error_code: str) -> dict[str, Any]:
        ...
        status: dict[str, Any] = self.fixture_validator.get_test_status().get(error_code, {})
        if not status:
            return {
    ...
    def get_all_test_statuses(self) -> dict[str, dict[str, Any]]:
        ...
        result: dict[str, dict[str, Any]] = self.fixture_validator.get_test_status()
        return result

    def is_test_enabled(self, test_id: str, touchpoint: str | None = None) -> bool:
        """
        ...
        if individual_override is not None:
            return bool(individual_override)
    ...
    def is_ai_test_enabled(self, analysis_type: str) -> bool:
        ...
        ai_config: dict[str, Any] = self.config.get("ai_tests", {})
        if not ai_config.get("enabled", True):
            return False

        return bool(ai_config.get("analyses", {}).get(analysis_type, True))

    def set_touchpoint_enabled(self, touchpoint: str, enabled: bool) -> None:
        """
    ...
    def set_test_enabled(self, test_id: str, enabled: bool, touchpoint: str | None = None) -> None:
        """
    ...
    def set_ai_test_enabled(self, analysis_type: str, enabled: bool) -> None:
        """
        ...
        ai_tests = cast(dict[str, Any], self.config["ai_tests"])
        if "analyses" not in ai_tests:
            ai_tests["analyses"] = {}
        analyses = cast(dict[str, Any], ai_tests["analyses"])
        analyses[analysis_type] = enabled
...
# Global instance
_test_config: TestConfiguration | None = None
