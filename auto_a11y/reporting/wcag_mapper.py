...
def enrich_wcag_criteria(criteria_list: list) -> list:
    ...
    """
    criterion_names = {
        '1.1.1': ftl('reports-1-1-1-non-text-content-level-a'),
        '1.2.1': ftl('reports-1-2-1-audio-only-and-video-only-prerecorded-level'),
        '1.2.2': ftl('reports-1-2-2-captions-prerecorded-level-a'),
        '1.2.3': ftl('reports-1-2-3-audio-description-or-media-alternative'),
        '1.2.4': ftl('reports-1-2-4-captions-live-level-aa'),
        '1.2.5': ftl('reports-1-2-5-audio-description-prerecorded-level-aa'),
        '1.3.1': ftl('reports-1-3-1-info-and-relationships-level-a'),
        '1.3.2': ftl('reports-1-3-2-meaningful-sequence-level-a'),
        '1.3.3': ftl('reports-1-3-3-sensory-characteristics-level-a'),
        '1.3.4': ftl('reports-1-3-4-orientation-level-aa'),
        '1.3.5': ftl('reports-1-3-5-identify-input-purpose-level-aa'),
        '1.4.1': ftl('reports-1-4-1-use-of-color-level-a'),
        '1.4.2': ftl('reports-1-4-2-audio-control-level-a'),
        '1.4.3': ftl('reports-1-4-3-contrast-minimum-level-aa'),
        '1.4.4': ftl('reports-1-4-4-resize-text-level-aa'),
        '1.4.5': ftl('reports-1-4-5-images-of-text-level-aa'),
        '1.4.6': ftl('reports-1-4-6-contrast-enhanced-level-aaa'),
        '1.4.8': ftl('reports-1-4-8-visual-presentation-level-aaa'),
        '1.4.10': ftl('reports-1-4-10-reflow-level-aa'),
        '1.4.11': ftl('reports-1-4-11-non-text-contrast-level-aa'),
        '1.4.12': ftl('reports-1-4-12-text-spacing-level-aa'),
        '1.4.13': ftl('reports-1-4-13-content-on-hover-or-focus-level-aa'),
        '2.1.1': ftl('reports-2-1-1-keyboard-level-a'),
        '2.1.2': ftl('reports-2-1-2-no-keyboard-trap-level-a'),
        '2.1.3': ftl('reports-2-1-3-keyboard-no-exception-level-aaa'),
        '2.1.4': ftl('reports-2-1-4-character-key-shortcuts-level-a'),
        '2.2.1': ftl('reports-2-2-1-timing-adjustable-level-a'),
        '2.2.2': ftl('reports-2-2-2-pause-stop-hide-level-a'),
        '2.2.6': ftl('reports-2-2-6-timeouts-level-aaa'),
        '2.3.1': ftl('reports-2-3-1-three-flashes-or-below-threshold-level-a'),
        '2.3.3': ftl('reports-2-3-3-animation-from-interactions-level-aaa'),
        '2.4.1': ftl('reports-2-4-1-bypass-blocks-level-a'),
        '2.4.2': ftl('reports-2-4-2-page-titled-level-a'),
        '2.4.3': ftl('reports-2-4-3-focus-order-level-a'),
        '2.4.4': ftl('reports-2-4-4-link-purpose-in-context-level-a'),
        '2.4.5': ftl('reports-2-4-5-multiple-ways-level-aa'),
        '2.4.6': ftl('reports-2-4-6-headings-and-labels-level-aa'),
        '2.4.7': ftl('reports-2-4-7-focus-visible-level-aa'),
        '2.4.8': ftl('reports-2-4-8-location-level-aaa'),
        '2.4.11': ftl('reports-2-4-11-focus-not-obscured-minimum-level-aa'),
        '2.4.13': ftl('reports-2-4-13-focus-appearance-level-aaa'),
        '2.5.1': ftl('reports-2-5-1-pointer-gestures-level-a'),
        '2.5.2': ftl('reports-2-5-2-pointer-cancellation-level-a'),
        '2.5.3': ftl('reports-2-5-3-label-in-name-level-a'),
        '2.5.4': ftl('reports-2-5-4-motion-actuation-level-a'),
        '2.5.7': ftl('reports-2-5-7-dragging-movements-level-aa'),
        '2.5.8': ftl('reports-2-5-8-target-size-minimum-level-aa'),
        '3.1.1': ftl('reports-3-1-1-language-of-page-level-a'),
        '3.1.2': ftl('reports-3-1-2-language-of-parts-level-aa'),
        '3.2.1': ftl('reports-3-2-1-on-focus-level-a'),
        '3.2.2': ftl('reports-3-2-2-on-input-level-a'),
        '3.2.3': ftl('reports-3-2-3-consistent-navigation-level-aa'),
        '3.2.4': ftl('reports-3-2-4-consistent-identification-level-aa'),
        '3.2.6': ftl('reports-3-2-6-consistent-help-level-a'),
        '3.3.1': ftl('reports-3-3-1-error-identification-level-a'),
        '3.3.2': ftl('reports-3-3-2-labels-or-instructions-level-a'),
        '3.3.3': ftl('reports-3-3-3-error-suggestion-level-aa'),
        '3.3.4': ftl('reports-3-3-4-error-prevention-legal-financial-data-level'),
        '3.3.5': ftl('reports-3-3-5-help-level-aaa'),
        '3.3.7': ftl('reports-3-3-7-redundant-entry-level-a'),
        '3.3.8': ftl('reports-3-3-8-accessible-authentication-minimum-level-aa'),
        '4.1.1': ftl('reports-4-1-1-parsing-level-a'),
        '4.1.2': ftl('reports-4-1-2-name-role-value-level-a'),
        '4.1.3': ftl('reports-4-1-3-status-messages-level-aa'),
    ...
    for criterion in criteria_list:
        ...
        if number in criterion_names:
            enriched.append(str(criterion_names[number]))
        else:
