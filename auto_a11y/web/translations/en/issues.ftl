...
AI_ErrAccessibilityIssue =
    ...
    .what-generic = Accessibility issue detected
...
AI_ErrAutoPlayingMedia =
    ...
    .what-generic = Auto-playing media cannot be controlled
...
AI_ErrClickableNotFocusable =
    ...
    .what-generic = Clickable element can't be reached by keyboard
...
AI_ErrCustomControlNoARIA =
    ...
    .what-generic = Custom control is missing ARIA attributes
...
AI_ErrDialogMissingLabel =
    ...
    .what-generic = Dialog is missing an accessible name
...
AI_ErrDialogMissingRole =
    ...
    .what-generic = Modal dialog is missing dialog role
...
AI_ErrDialogNoCloseButton =
    ...
    .what-generic = Modal has no visible way to close it
...
AI_ErrDialogWithoutARIA =
    ...
    .what-generic = Element appears to be a dialog or modal but lacks proper ARIA markup
...
AI_ErrForeignTextUnmarked =
    ...
    .what-generic = Foreign language text is not marked with lang attribute
...
AI_ErrHeadingIssue =
    ...
    .what-generic = Heading structure has accessibility issues
...
AI_ErrHeadingLevelMismatch =
    ...
    .what-generic = Heading level doesn't match visual hierarchy
...
AI_ErrInfiniteAnimationNoPause =
    ...
    .what-generic = Infinite animation cannot be paused
...
AI_ErrInteractiveElementIssue =
    ...
    .what-generic = Interactive element has accessibility issues
...
AI_ErrModalFocusTrap =
    ...
    .what-generic = Modal or dialog does not properly trap focus
...
AI_ErrNonSemanticButton =
    ...
    .what-generic = Non-semantic element used as a button
...
AI_ErrNonSemanticLink =
    ...
    .what-generic = Non-semantic element used as a link
...
AI_ErrPageLanguageMissing =
    ...
    .what-generic = Page language is not declared
...
AI_ErrPageLanguageWrong =
    ...
    .what-generic = Page language declaration doesn't match actual content
...
AI_ErrSkippedHeading =
    ...
    .what-generic = Heading levels are skipped in the document hierarchy
...
AI_ErrTabsWithoutARIA =
    ...
    .what-generic = Tab interface lacks proper ARIA markup
...
AI_ErrVisualGroupingBroken =
    ...
    .what-generic = Visual grouping doesn't match DOM structure
...
AI_ErrVisualHeadingNotMarked =
    ...
    .what-generic = Text appears visually as a heading but is not marked up with proper heading tags
...
AI_ErrVisualHierarchyInconsistent =
    ...
    .what-generic = Visual heading sizes are inconsistent with their importance
...
AI_WarnDialogBackgroundNotInert =
    ...
    .what-generic = Background content behind modal is not properly inert
...
AI_WarnFocusIndicatorWeak =
    ...
    .what-generic = Focus indicator is hard to see or missing
...
AI_WarnNoReducedMotion =
    ...
    .what-generic = Site doesn't respect reduced motion preference
...
AI_WarnPotentialFlashing =
    ...
    .what-generic = Potential flashing content detected
...
DiscoAsideFound =
    ...
    .what-generic = A complementary region has been detected on this page
...
DiscoFontFound =
    ...
    .what-generic = Font is used at multiple sizes on this page
...
DiscoFooterFound =
    ...
    .what-generic = A contentinfo landmark has been detected on this page
...
DiscoFormOnPage =
    ...
    .what-generic = A form has been detected on this page
...
DiscoHeaderFound =
    ...
    .what-generic = A banner landmark has been detected on this page
...
DiscoNavFound =
    ...
    .what-generic = A navigation region has been detected on this page
...
DiscoResponsiveBreakpoints =
    ...
    .what-generic = Page defines responsive breakpoints in CSS media queries
...
DiscoSearchFound =
    ...
    .what-generic = A search landmark has been detected on this page
...
DiscoSectionFound =
    ...
    .what-generic = A section region has been detected on this page
...
ErrAriaLabelMayNotBeFoundByVoiceControl =
    ...
    .what-generic = Element's aria-label may not be discoverable by voice control
...
ErrCarouselWithoutARIA =
    ...
    .what-generic = Carousel or slider lacks proper ARIA markup and controls
...
ErrContentObscuring =
    ...
    .what-generic = Non-modal floating element obscures interactive content that users may try to access
...
ErrDropdownWithoutARIA =
    ...
    .what-generic = Dropdown menu lacks proper ARIA markup
...
ErrDuplicateLandmarkWithoutName =
    ...
    .what-generic = Multiple landmarks of the same type exist, but this instance lacks a unique accessible name to distinguish it from the others
...
ErrEmptyHeading =
    ...
    .what-generic = Heading element contains only whitespace or special characters
...
ErrFakeListImplementation =
    ...
    .what-generic = Element contains list-like items but does not use proper list markup
...
ErrFieldAriaRefDoesNotExist =
    ...
    .what-generic = ARIA attribute references non-existent element ID
...
ErrHeadingLevelsSkipped =
    ...
    .what-generic = Page heading structure skips intermediate levels, breaking document hierarchy
...
ErrHeadingsDontStartWithH1 =
    ...
    .what-generic = Page heading structure does not start with h1
...
ErrInaccessibleFont =
    ...
    .what-generic = Font being used is known to be difficult to read
...
ErrInfiniteAnimation =
    ...
    {"{"}animationCSS{"}"}
    .what-generic = Animation runs infinitely without pause controls
...
ErrInvalidLangChange =
    ...
    .what-generic = Element has invalid language code that is not a valid ISO 639 language code
...
ErrInvalidLanguageCode =
    ...
    .what-generic = Language attribute contains invalid code that doesn't conform to ISO 639 standards
...
ErrLabelContainsMultipleFields =
    ...
    .what-generic = Single label contains multiple form fields
...
ErrLargeTextContrastAA =
    ...
    .what-generic = Large text fails WCAG AA contrast requirements
...
ErrLargeTextContrastAAA =
    ...
    .what-generic = Large text fails WCAG AAA contrast requirements
...
ErrMissingInteractiveRole =
    ...
    .what-generic = Interactive element lacks appropriate ARIA role
...
ErrMissingTabindex =
    ...
    .what-generic = Element has a mouse event handler but lacks tabindex, making it inaccessible to keyboard users
...
ErrModalMissingHeading =
    ...
    .what-generic = Modal has incorrect heading level for proper document structure
...
ErrModalNoHeading =
    ...
    .what-generic = Modal or dialog has no heading to identify its purpose
...
ErrMultipleBannerLandmarksOnPage =
    ...
    .what-generic = Page contains multiple banner landmarks, but should have at most one
...
ErrMultipleContentinfoLandmarksOnPage =
    ...
    .what-generic = Page contains multiple contentinfo landmarks, but should have at most one
...
ErrMultipleH1 =
    ...
    .what-generic = Page contains multiple h1 elements instead of just one
...
ErrMultipleH1HeadingsOnPage =
    ...
    .what-generic = Page contains multiple h1 elements, but best practice is to have exactly one h1 per page
...
ErrMultipleMainLandmarksOnPage =
    ...
    .what-generic = Page contains multiple main landmarks, but should have exactly one
...
ErrMultiplePageTitles =
    ...
    .what-generic = Multiple title elements found in the document head
...
ErrNoReducedMotionSupport =
    ...
    .what-generic = Animations do not respect prefers-reduced-motion setting
...
ErrPartialTextContrastAA =
    ...
    .what-generic = Text fails contrast and overflows container boundaries
...
ErrPartialTextContrastAAA =
    ...
    .what-generic = Text fails enhanced contrast and overflows container boundaries
...
ErrSkippedHeadingLevel =
    ...
    .what-generic = Heading levels are not in sequential order
...
ErrSmallText =
    ...
    .what-generic = Text size is below the recommended minimum of 16px for comfortable reading
...
ErrTabOrderViolation =
    ...
    .what-generic = Element's position in tab order does not match its visual position on screen
...
ErrTextContrastAA =
    ...
    .what-generic = Normal text fails WCAG AA contrast requirements
...
ErrTextContrastAAA =
    ...
    .what-generic = Normal text fails WCAG AAA contrast requirements
...
InfoHeadingNearLengthLimit =
    ...
    .what-generic = Heading is approaching the recommended character limit
...
WarnAmbiguousTabOrder =
    ...
    .what-generic = Element's position in tab order may not match its visual position
...
WarnCustomBulletStyling =
    ...
    .what-generic = List item uses custom styling for bullets instead of standard list-style-type
...
WarnFieldLabelledUsingAriaLabel =
    ...
    .what-generic = Field is labeled using aria-label, which is valid but may have usability considerations
...
WarnFontNotInRecommenedListForA11y =
    ...
    .what-generic = Font is not included in the recommended list of accessibility-friendly fonts
...
WarnFormLandmarkAccessibleNameUsesForm =
    ...
    .what-generic = Form landmark accessible name includes redundant word "form"
...
WarnHeadingOver60CharsLong =
    ...
    .what-generic = Heading text exceeds the recommended character limit
...
WarnIconFontBulletsInList =
    ...
    .what-generic = List item uses icon font elements instead of CSS list-style-type property
...
WarnLongAnimation =
    ...
    {"{"}animationCSS{"}"}
    .what-generic = Animation duration exceeds recommended time limit
...
WarnMultipleTitleElements =
    ...
    .what-generic = Multiple title elements found in the document head, which may cause unpredictable behavior
...
WarnPageTitleTooLong =
    ...
    .what-generic = Page title exceeds the recommended character limit
...
WarnPageTitleTooShort =
    ...
    .what-generic = Page title is potentially not descriptive enough
...
WarnRedundantTitleAttr =
    ...
    .what-generic = Element has a title attribute that duplicates or overlaps with visible text content
...
WarnSmallLineHeight =
    ...
    .what-generic = Line height ratio is below the recommended minimum for readability
...
WarnTabindexNoVisibleFocus =
    ...
    .what-generic = Non-interactive element with tabindex lacks visible focus indicator - review the purpose of tabindex on this element
...
WarnTextContrastCannotCalculate =
    ...
    .what-generic = Text contrast requires manual verification
...
AI_ErrAlertWithoutARIA =
    ...
    .what-generic = An alert or status message lacks the ARIA role or aria-live attribute needed for screen readers to announce it.
...
AI_ErrAudioWithoutTranscript =
    ...
    .what-generic = Audio-only content is provided without an equivalent text transcript.
...
AI_ErrAutocompleteWithoutARIA =
    ...
    .what-generic = A custom autocomplete widget lacks the ARIA combobox markup needed for assistive technology to understand and operate it.
...
AI_ErrAutoplayMedia =
    ...
    .what-generic = Audio or video autoplays on page load with no user control to pause, stop, or mute it.
...
AI_ErrBreadcrumbsWithoutARIA =
    ...
    .what-generic = Breadcrumb navigation lacks a nav element with aria-label="Breadcrumb" and an aria-current marker, so assistive technologies cannot identify it as a breadcrumb trail.
...
AI_ErrCardWithoutARIA =
    ...
    .what-generic = A card component is built from generic divs without semantic HTML or ARIA, and clickable cards lack an interactive role and keyboard support.
...
AI_ErrCheckboxGroupWithoutARIA =
    ...
    .what-generic = A group of checkboxes lacks the ARIA roles, checked states, or fieldset/legend and label grouping needed for assistive technology to identify and operate them.
...
AI_ErrDatePickerWithoutARIA =
    ...
    .what-generic = A custom date picker is missing the ARIA roles, labels, and grouping needed for assistive technology to interpret and operate it.
...
AI_ErrDisclosureWithoutARIA =
    ...
    .what-generic = A show/hide disclosure control lacks the aria-expanded state and button semantics needed for assistive technologies to announce and operate it.
...
AI_ErrFeedWithoutARIA =
    ...
    .what-generic = A dynamic feed or stream of items does not use the ARIA feed pattern (role="feed", role="article", aria-posinset, aria-setsize, aria-busy).
...
AI_ErrFlashingContent =
    ...
    .what-generic = Content flashes more than three times per second, which can trigger photosensitive seizures.
...
AI_ErrFormErrorNotAnnounced =
    ...
    .what-generic = A form validation error is shown only visually and is not programmatically associated with its field or announced to assistive technology.
...
AI_ErrLandmarkWithoutLabel =
    ...
    .what-generic = A page has multiple landmarks of the same type but they lack distinguishing accessible labels.
...
AI_ErrLoadingStateNotAnnounced =
    ...
    .what-generic = A visual loading or progress indicator is not exposed to assistive technology through a live region, so its status changes are never announced.
...
AI_ErrMeterWithoutARIA =
    ...
    .what-generic = A custom meter or gauge lacks the ARIA role and value properties (or a native meter element) needed to expose its measurement to assistive technology.
...
AI_ErrMissingLiveRegion =
    ...
    .what-generic = Content that updates dynamically lacks an ARIA live region, so screen readers do not announce the change.
...
AI_ErrMissingSkipLink =
    ...
    .what-generic = The page has repeated navigation blocks but no skip link letting keyboard users bypass them to reach the main content.
...
AI_ErrModalWithoutARIA =
    ...
    .what-generic = A modal dialog lacks role="dialog", aria-modal="true", an accessible name, and proper focus management.
...
AI_ErrMotionWithoutControl =
    ...
    .what-generic = Automatically moving content runs without any control to pause, stop, or hide it and ignores reduced-motion preferences.
...
AI_ErrNotificationWithoutARIA =
    ...
    .what-generic = A dynamic notification is shown without a status/alert role or aria-live region, so screen readers never announce it.
...
AI_ErrPaginationWithoutARIA =
    ...
    .what-generic = Pagination controls are missing a labelled nav landmark and an aria-current marker for the current page.
...
AI_ErrProgressBarWithoutARIA =
    ...
    .what-generic = A visual progress or loading indicator has no progressbar role or ARIA value attributes, so its status is not exposed to assistive technology.
...
AI_ErrRadioGroupWithoutARIA =
    ...
    .what-generic = A radio button group is missing the ARIA roles, selection state, and grouping that screen readers need to identify and operate it.
...
AI_ErrSearchWithoutARIA =
    ...
    .what-generic = Search functionality is missing a search landmark and accessible names on its input and button.
...
AI_ErrSliderWithoutARIA =
    ...
    .what-generic = A slider control is missing the slider role, value attributes, or accessible name required by assistive technology.
...
AI_ErrSpinbuttonWithoutARIA =
    ...
    .what-generic = A spinbutton or number control is missing the role, value attributes, or accessible label that screen readers need.
...
AI_ErrTimeLimitNoWarning =
    ...
    .what-generic = A time limit expires and logs the user out or redirects them without any advance warning or option to extend the time.
...
AI_ErrToggleWithoutARIA =
    ...
    .what-generic = Toggle switch lacks role="switch" and aria-checked state.
...
AI_ErrTreeViewWithoutARIA =
    ...
    .what-generic = An interactive tree view is missing the ARIA tree roles, expanded-state, and keyboard support that assistive technology needs to convey and operate its hierarchy.
...
AI_ErrVideoWithoutCaptions =
    ...
    .what-generic = Video content is provided without captions for its audio.
...
AI_InfoContentOrder =
    ...
    .what-generic = Visual layout may present content in a different order than the DOM source sequence.
...
AI_WarnBannerRoleOnHeader =
    ...
    .what-generic = A <header> element has an explicit role="banner" that is redundant on a top-level header or incorrect on a section-scoped header.
...
AI_WarnComplementaryRoleOnAside =
    ...
    .what-generic = An aside element carries a redundant role="complementary" that duplicates its native HTML5 landmark semantics.
...
AI_WarnContentinfoRoleOnFooter =
    ...
    .what-generic = A footer element has an explicit role="contentinfo" that is either redundant with native HTML semantics or incorrectly applied to a nested footer.
...
AI_WarnFormRoleOnForm =
    ...
    .what-generic = A native form element has a redundant explicit role="form" that duplicates its implicit semantics.
...
AI_WarnMainRoleOnMain =
    ...
    .what-generic = An HTML element carries an explicit ARIA role that duplicates the role it already has natively.
...
AI_WarnNavigationRoleOnNav =
    ...
    .what-generic = A native HTML element has been given an ARIA role that duplicates the role it already provides implicitly.
...
AI_WarnPossibleReadingOrderIssue =
    ...
    .what-generic = The visual layout may produce a reading order that differs from the DOM source order followed by assistive technology.
...
AI_WarnRegionWithoutLabel =
    ...
    .what-generic = A region landmark has no accessible name, so it cannot be identified during landmark navigation.
...
AI_WarnSearchRoleOnForm =
    ...
    .what-generic = A search landmark role is placed directly on a form element instead of on a wrapping container, overriding the form's native semantics.
...
AI_WarnTableWithComplexStructure =
    ...
    .what-generic = A complex table does not associate its data cells with their headers using scope or id/headers attributes.
...
AI_WarnVideoWithoutCaptions =
    ...
    .what-generic = A video with spoken audio provides no synchronized caption track.
